...
// checks if the V0037JobResponseProperties type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0037JobResponseProperties{}
...
func (o V0037JobResponseProperties) ToMap() (map[string]interface{}, error) {
