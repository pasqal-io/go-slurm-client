...
func (o V0037JobProperties) ToMap() (map[string]interface{}, error) {
	...
	if !IsNil(o.AccountGatherFreqency) {
...
func (o *V0037JobProperties) UnmarshalJSON(data []byte) (err error) {
	...
	varV0037JobProperties := _V0037JobProperties{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV0037JobProperties)

	if err != nil {
		return err
	}

	*o = V0037JobProperties(varV0037JobProperties)
