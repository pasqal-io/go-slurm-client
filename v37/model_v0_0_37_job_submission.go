...
type _V0037JobSubmission V0037JobSubmission
...
func (o *V0037JobSubmission) UnmarshalJSON(data []byte) (err error) {
	...
	varV0037JobSubmission := _V0037JobSubmission{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varV0037JobSubmission)

	if err != nil {
		return err
	}

	*o = V0037JobSubmission(varV0037JobSubmission)
