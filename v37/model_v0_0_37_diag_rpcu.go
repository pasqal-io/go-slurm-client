...
// checks if the V0037DiagRpcu type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0037DiagRpcu{}
...
func (o V0037DiagRpcu) ToMap() (map[string]interface{}, error) {
