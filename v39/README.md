...
- API version: Slurm-23.11.11 & openapi/dbv0.0.39 & openapi/slurmctld & openapi/slurmdbd & openapi/v0.0.39
...
```go
import openapi "github.com/pasqal-io/go-slurm-client/v39"
```
