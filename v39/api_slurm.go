...
func (a *SlurmAPIService) SlurmV0040DeleteJobsExecute(r ApiSlurmV0040DeleteJobsRequest) (*V0040OpenapiKillJobsResp, *http.Response, error) {
	...
	localVarQueryParams := url.Values{}
	localVarFormParams := url.Values{}
	if r.v0040KillJobsMsg == nil {
		return localVarReturnValue, nil, reportError("v0040KillJobsMsg is required and must be specified")
	}
...
func (r ApiSlurmV0040GetJobsStateRequest) Execute() (*V0040OpenapiJobStateResp, *http.Response, error) {
...
// Execute executes the request
//  @return V0040OpenapiJobStateResp
func (a *SlurmAPIService) SlurmV0040GetJobsStateExecute(r ApiSlurmV0040GetJobsStateRequest) (*V0040OpenapiJobStateResp, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *V0040OpenapiJobStateResp
	)
	...
	if localVarHTTPResponse.StatusCode >= 300 {
		newErr := &GenericOpenAPIError{
			...
			var v V0040OpenapiJobStateResp
			err = a.client.decode(&v, localVarBody, localVarHTTPResponse.Header.Get("Content-Type"))
			if err != nil {
				newErr.error = err.Error()
				return localVarReturnValue, localVarHTTPResponse, newErr
...
func (a *SlurmAPIService) SlurmdbV0039GetAccountExecute(r ApiSlurmdbV0039GetAccountRequest) (*Dbv0039AccountInfo, *http.Response, error) {
	...
	if r.withDeleted != nil {
        ...
        parameterAddToHeaderOrQuery(localVarQueryParams, "with_deleted", defaultValue, "form", "")
...
func (a *SlurmAPIService) SlurmdbV0039GetJobsExecute(r ApiSlurmdbV0039GetJobsRequest) (*Dbv0039JobInfo, *http.Response, error) {
	...
	if r.skipSteps != nil {
        ...
        var defaultValue string = "false"
        parameterAddToHeaderOrQuery(localVarQueryParams, "skip_steps", defaultValue, "form", "")
	...
	if r.disableWaitForResult != nil {
        ...
        var defaultValue string = "false"
        parameterAddToHeaderOrQuery(localVarQueryParams, "disable_wait_for_result", defaultValue, "form", "")
