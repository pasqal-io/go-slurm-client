...
func main() {
	v0040KillJobsMsg := *openapiclient.NewV0040KillJobsMsg() // V0040KillJobsMsg | description of jobs to signal
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **v0040KillJobsMsg** | [**V0040KillJobsMsg**](V0040KillJobsMsg.md) | description of jobs to signal | 
...
> V0040OpenapiJobStateResp SlurmV0040GetJobsState(ctx).JobId(jobId).Execute()
...
func main() {
	...
	// response from `SlurmV0040GetJobsState`: V0040OpenapiJobStateResp
...
[**V0040OpenapiJobStateResp**](V0040OpenapiJobStateResp.md)
