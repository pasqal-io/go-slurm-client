...
func main() {
	v0040OpenapiUsersAddCondResp := *openapiclient.NewV0040OpenapiUsersAddCondResp(*openapiclient.NewV0040UsersAddCond([]string{"Users_example"}), *openapiclient.NewV0040UserShort()) // V0040OpenapiUsersAddCondResp | Create users with conditional association
