...
// checks if the SlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack{}

// SlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack Maximum size of stack segment, in bytes.
type SlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack struct {
...
func NewSlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack() *SlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack {
	this := SlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack{}
	return &this
}
...
func (o SlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack) MarshalJSON() ([]byte, error) {
...
func (o SlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack) ToMap() (map[string]interface{}, error) {
...
type NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack struct {
	value *SlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack
	isSet bool
}

func (v NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack) Get() *SlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack {
	return v.value
}

func (v *NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack) Set(val *SlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack) {
	v.value = val
	v.isSet = true
}

func (v NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack) IsSet() bool {
	return v.isSet
}

func (v *NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack(val *SlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack) *NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack {
	return &NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack{value: val, isSet: true}
}

func (v NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsStack) UnmarshalJSON(src []byte) error {
	v.isSet = true
