...
// checks if the SlurmV0041GetLicenses200ResponseLicensesInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SlurmV0041GetLicenses200ResponseLicensesInner{}

// SlurmV0041GetLicenses200ResponseLicensesInner struct for SlurmV0041GetLicenses200ResponseLicensesInner
type SlurmV0041GetLicenses200ResponseLicensesInner struct {
	// Name of the license
...
func NewSlurmV0041GetLicenses200ResponseLicensesInner() *SlurmV0041GetLicenses200ResponseLicensesInner {
	this := SlurmV0041GetLicenses200ResponseLicensesInner{}
	return &this
}
...
func (o SlurmV0041GetLicenses200ResponseLicensesInner) MarshalJSON() ([]byte, error) {
...
func (o SlurmV0041GetLicenses200ResponseLicensesInner) ToMap() (map[string]interface{}, error) {
...
type NullableSlurmV0041GetLicenses200ResponseLicensesInner struct {
	value *SlurmV0041GetLicenses200ResponseLicensesInner
	isSet bool
}

func (v NullableSlurmV0041GetLicenses200ResponseLicensesInner) Get() *SlurmV0041GetLicenses200ResponseLicensesInner {
	return v.value
}

func (v *NullableSlurmV0041GetLicenses200ResponseLicensesInner) Set(val *SlurmV0041GetLicenses200ResponseLicensesInner) {
	v.value = val
	v.isSet = true
}

func (v NullableSlurmV0041GetLicenses200ResponseLicensesInner) IsSet() bool {
	return v.isSet
}

func (v *NullableSlurmV0041GetLicenses200ResponseLicensesInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSlurmV0041GetLicenses200ResponseLicensesInner(val *SlurmV0041GetLicenses200ResponseLicensesInner) *NullableSlurmV0041GetLicenses200ResponseLicensesInner {
	return &NullableSlurmV0041GetLicenses200ResponseLicensesInner{value: val, isSet: true}
}

func (v NullableSlurmV0041GetLicenses200ResponseLicensesInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSlurmV0041GetLicenses200ResponseLicensesInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
