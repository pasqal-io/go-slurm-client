...
// checks if the SlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc{}

// SlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc Number of processes.
type SlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc struct {
...
func NewSlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc() *SlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc {
	this := SlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc{}
	return &this
}
...
func (o SlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc) MarshalJSON() ([]byte, error) {
...
func (o SlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc) ToMap() (map[string]interface{}, error) {
...
type NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc struct {
	value *SlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc
	isSet bool
}

func (v NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc) Get() *SlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc {
	return v.value
}

func (v *NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc) Set(val *SlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc) {
	v.value = val
	v.isSet = true
}

func (v NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc) IsSet() bool {
	return v.isSet
}

func (v *NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc(val *SlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc) *NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc {
	return &NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc{value: val, isSet: true}
}

func (v NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSlurmV0041PostJobSubmitRequestJobsInnerRlimitsNproc) UnmarshalJSON(src []byte) error {
	v.isSet = true
