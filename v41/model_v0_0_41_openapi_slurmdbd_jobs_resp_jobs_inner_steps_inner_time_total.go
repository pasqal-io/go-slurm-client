...
// checks if the V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal{}

// V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal struct for V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal
type V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal struct {
...
func NewV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal() *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal {
	this := V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal{}
	return &this
}
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal) MarshalJSON() ([]byte, error) {
...
func (o V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal) ToMap() (map[string]interface{}, error) {
...
type NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal struct {
	value *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal
	isSet bool
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal) Get() *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal {
	return v.value
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal) Set(val *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal) {
	v.value = val
	v.isSet = true
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal) IsSet() bool {
	return v.isSet
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal(val *V0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal) *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal {
	return &NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal{value: val, isSet: true}
}

func (v NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0041OpenapiSlurmdbdJobsRespJobsInnerStepsInnerTimeTotal) UnmarshalJSON(src []byte) error {
	v.isSet = true
