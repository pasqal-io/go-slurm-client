...
// checks if the SlurmV0041GetDiag200ResponseStatisticsBfExit type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SlurmV0041GetDiag200ResponseStatisticsBfExit{}

// SlurmV0041GetDiag200ResponseStatisticsBfExit Reasons for which the backfill scheduling cycle exited since last reset
type SlurmV0041GetDiag200ResponseStatisticsBfExit struct {
...
func NewSlurmV0041GetDiag200ResponseStatisticsBfExit() *SlurmV0041GetDiag200ResponseStatisticsBfExit {
	this := SlurmV0041GetDiag200ResponseStatisticsBfExit{}
	return &this
}
...
func (o SlurmV0041GetDiag200ResponseStatisticsBfExit) MarshalJSON() ([]byte, error) {
...
func (o SlurmV0041GetDiag200ResponseStatisticsBfExit) ToMap() (map[string]interface{}, error) {
...
type NullableSlurmV0041GetDiag200ResponseStatisticsBfExit struct {
	value *SlurmV0041GetDiag200ResponseStatisticsBfExit
	isSet bool
}

func (v NullableSlurmV0041GetDiag200ResponseStatisticsBfExit) Get() *SlurmV0041GetDiag200ResponseStatisticsBfExit {
	return v.value
}

func (v *NullableSlurmV0041GetDiag200ResponseStatisticsBfExit) Set(val *SlurmV0041GetDiag200ResponseStatisticsBfExit) {
	v.value = val
	v.isSet = true
}

func (v NullableSlurmV0041GetDiag200ResponseStatisticsBfExit) IsSet() bool {
	return v.isSet
}

func (v *NullableSlurmV0041GetDiag200ResponseStatisticsBfExit) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSlurmV0041GetDiag200ResponseStatisticsBfExit(val *SlurmV0041GetDiag200ResponseStatisticsBfExit) *NullableSlurmV0041GetDiag200ResponseStatisticsBfExit {
	return &NullableSlurmV0041GetDiag200ResponseStatisticsBfExit{value: val, isSet: true}
}

func (v NullableSlurmV0041GetDiag200ResponseStatisticsBfExit) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSlurmV0041GetDiag200ResponseStatisticsBfExit) UnmarshalJSON(src []byte) error {
	v.isSet = true
