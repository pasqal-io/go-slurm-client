...
// checks if the SlurmV0041GetDiag200ResponseStatisticsJobStatesTs type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SlurmV0041GetDiag200ResponseStatisticsJobStatesTs{}

// SlurmV0041GetDiag200ResponseStatisticsJobStatesTs When the job state counts were gathered (UNIX timestamp)
type SlurmV0041GetDiag200ResponseStatisticsJobStatesTs struct {
...
func NewSlurmV0041GetDiag200ResponseStatisticsJobStatesTs() *SlurmV0041GetDiag200ResponseStatisticsJobStatesTs {
	this := SlurmV0041GetDiag200ResponseStatisticsJobStatesTs{}
	return &this
}
...
func (o SlurmV0041GetDiag200ResponseStatisticsJobStatesTs) MarshalJSON() ([]byte, error) {
...
func (o SlurmV0041GetDiag200ResponseStatisticsJobStatesTs) ToMap() (map[string]interface{}, error) {
...
type NullableSlurmV0041GetDiag200ResponseStatisticsJobStatesTs struct {
	value *SlurmV0041GetDiag200ResponseStatisticsJobStatesTs
	isSet bool
}

func (v NullableSlurmV0041GetDiag200ResponseStatisticsJobStatesTs) Get() *SlurmV0041GetDiag200ResponseStatisticsJobStatesTs {
	return v.value
}

func (v *NullableSlurmV0041GetDiag200ResponseStatisticsJobStatesTs) Set(val *SlurmV0041GetDiag200ResponseStatisticsJobStatesTs) {
	v.value = val
	v.isSet = true
}

func (v NullableSlurmV0041GetDiag200ResponseStatisticsJobStatesTs) IsSet() bool {
	return v.isSet
}

func (v *NullableSlurmV0041GetDiag200ResponseStatisticsJobStatesTs) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSlurmV0041GetDiag200ResponseStatisticsJobStatesTs(val *SlurmV0041GetDiag200ResponseStatisticsJobStatesTs) *NullableSlurmV0041GetDiag200ResponseStatisticsJobStatesTs {
	return &NullableSlurmV0041GetDiag200ResponseStatisticsJobStatesTs{value: val, isSet: true}
}

func (v NullableSlurmV0041GetDiag200ResponseStatisticsJobStatesTs) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSlurmV0041GetDiag200ResponseStatisticsJobStatesTs) UnmarshalJSON(src []byte) error {
	v.isSet = true
