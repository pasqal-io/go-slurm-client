...
// checks if the SlurmV0041GetDiag200ResponseStatisticsReqTimeStart type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SlurmV0041GetDiag200ResponseStatisticsReqTimeStart{}

// SlurmV0041GetDiag200ResponseStatisticsReqTimeStart When the data in the report started (UNIX timestamp)
type SlurmV0041GetDiag200ResponseStatisticsReqTimeStart struct {
...
func NewSlurmV0041GetDiag200ResponseStatisticsReqTimeStart() *SlurmV0041GetDiag200ResponseStatisticsReqTimeStart {
	this := SlurmV0041GetDiag200ResponseStatisticsReqTimeStart{}
	return &this
}
...
func (o SlurmV0041GetDiag200ResponseStatisticsReqTimeStart) MarshalJSON() ([]byte, error) {
...
func (o SlurmV0041GetDiag200ResponseStatisticsReqTimeStart) ToMap() (map[string]interface{}, error) {
...
type NullableSlurmV0041GetDiag200ResponseStatisticsReqTimeStart struct {
	value *SlurmV0041GetDiag200ResponseStatisticsReqTimeStart
	isSet bool
}

func (v NullableSlurmV0041GetDiag200ResponseStatisticsReqTimeStart) Get() *SlurmV0041GetDiag200ResponseStatisticsReqTimeStart {
	return v.value
}

func (v *NullableSlurmV0041GetDiag200ResponseStatisticsReqTimeStart) Set(val *SlurmV0041GetDiag200ResponseStatisticsReqTimeStart) {
	v.value = val
	v.isSet = true
}

func (v NullableSlurmV0041GetDiag200ResponseStatisticsReqTimeStart) IsSet() bool {
	return v.isSet
}

func (v *NullableSlurmV0041GetDiag200ResponseStatisticsReqTimeStart) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableSlurmV0041GetDiag200ResponseStatisticsReqTimeStart(val *SlurmV0041GetDiag200ResponseStatisticsReqTimeStart) *NullableSlurmV0041GetDiag200ResponseStatisticsReqTimeStart {
	return &NullableSlurmV0041GetDiag200ResponseStatisticsReqTimeStart{value: val, isSet: true}
}

func (v NullableSlurmV0041GetDiag200ResponseStatisticsReqTimeStart) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableSlurmV0041GetDiag200ResponseStatisticsReqTimeStart) UnmarshalJSON(src []byte) error {
	v.isSet = true
