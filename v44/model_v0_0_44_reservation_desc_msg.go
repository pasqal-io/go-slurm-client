...
// checks if the V0044ReservationDescMsg type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0044ReservationDescMsg{}

// V0044ReservationDescMsg struct for V0044ReservationDescMsg
...
// SetCoreCount gets a reference to the given V0044Uint32NoValStruct and assigns it to the CoreCount field.
...
// SetDuration gets a reference to the given V0044Uint32NoValStruct and assigns it to the Duration field.
...
// SetMaxStartDelay gets a reference to the given V0044Uint32NoValStruct and assigns it to the MaxStartDelay field.
...
func (o V0044ReservationDescMsg) MarshalJSON() ([]byte, error) {
...
func (o V0044ReservationDescMsg) ToMap() (map[string]interface{}, error) {
...
type NullableV0044ReservationDescMsg struct {
	value *V0044ReservationDescMsg
	isSet bool
}

func (v NullableV0044ReservationDescMsg) Get() *V0044ReservationDescMsg {
	return v.value
}

func (v *NullableV0044ReservationDescMsg) Set(val *V0044ReservationDescMsg) {
	v.value = val
	v.isSet = true
}

func (v NullableV0044ReservationDescMsg) IsSet() bool {
	return v.isSet
}

func (v *NullableV0044ReservationDescMsg) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0044ReservationDescMsg(val *V0044ReservationDescMsg) *NullableV0044ReservationDescMsg {
	return &NullableV0044ReservationDescMsg{value: val, isSet: true}
}

func (v NullableV0044ReservationDescMsg) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0044ReservationDescMsg) UnmarshalJSON(src []byte) error {
	v.isSet = true
