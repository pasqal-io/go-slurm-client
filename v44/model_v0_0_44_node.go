...
// checks if the V0044Node type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0044Node{}

// V0044Node struct for V0044Node
...
// SetBootTime gets a reference to the given V0044Uint64NoValStruct and assigns it to the BootTime field.
...
func (o *V0044Node) GetTlsCertLastRenewal() V0044Uint64NoValStruct {
	if o == nil || IsNil(o.TlsCertLastRenewal) {
		var ret V0044Uint64NoValStruct
		return ret
	}
...
// SetTlsCertLastRenewal gets a reference to the given V0044Uint64NoValStruct and assigns it to the TlsCertLastRenewal field.
...
// SetFreeMem gets a reference to the given V0044Uint64NoValStruct and assigns it to the FreeMem field.
...
// SetEnergy gets a reference to the given V0044AcctGatherEnergy and assigns it to the Energy field.
...
// SetLastBusy gets a reference to the given V0044Uint64NoValStruct and assigns it to the LastBusy field.
...
// SetReasonChangedAt gets a reference to the given V0044Uint64NoValStruct and assigns it to the ReasonChangedAt field.
...
// SetResumeAfter gets a reference to the given V0044Uint64NoValStruct and assigns it to the ResumeAfter field.
...
// SetSlurmdStartTime gets a reference to the given V0044Uint64NoValStruct and assigns it to the SlurmdStartTime field.
...
func (o V0044Node) MarshalJSON() ([]byte, error) {
...
func (o V0044Node) ToMap() (map[string]interface{}, error) {
...
type NullableV0044Node struct {
	value *V0044Node
	isSet bool
}

func (v NullableV0044Node) Get() *V0044Node {
	return v.value
}

func (v *NullableV0044Node) Set(val *V0044Node) {
	v.value = val
	v.isSet = true
}

func (v NullableV0044Node) IsSet() bool {
	return v.isSet
}

func (v *NullableV0044Node) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0044Node(val *V0044Node) *NullableV0044Node {
	return &NullableV0044Node{value: val, isSet: true}
}

func (v NullableV0044Node) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0044Node) UnmarshalJSON(src []byte) error {
	v.isSet = true
