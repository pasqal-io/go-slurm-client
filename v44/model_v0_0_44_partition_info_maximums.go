...
// checks if the V0044PartitionInfoMaximums type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0044PartitionInfoMaximums{}

// V0044PartitionInfoMaximums struct for V0044PartitionInfoMaximums
type V0044PartitionInfoMaximums struct {
	...
	Oversubscribe *V0044PartitionInfoMaximumsOversubscribe `json:"oversubscribe,omitempty"`
...
func NewV0044PartitionInfoMaximums() *V0044PartitionInfoMaximums {
	this := V0044PartitionInfoMaximums{}
	return &this
}
...
// SetCpusPerNode gets a reference to the given V0044Uint32NoValStruct and assigns it to the CpusPerNode field.
...
// SetCpusPerSocket gets a reference to the given V0044Uint32NoValStruct and assigns it to the CpusPerSocket field.
...
// SetNodes gets a reference to the given V0044Uint32NoValStruct and assigns it to the Nodes field.
...
func (o *V0044PartitionInfoMaximums) GetOversubscribe() V0044PartitionInfoMaximumsOversubscribe {
	if o == nil || IsNil(o.Oversubscribe) {
		var ret V0044PartitionInfoMaximumsOversubscribe
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *V0044PartitionInfoMaximums) GetOversubscribeOk() (*V0044PartitionInfoMaximumsOversubscribe, bool) {
	if o == nil || IsNil(o.Oversubscribe) {
		return nil, false
	}
...
// SetOversubscribe gets a reference to the given V0044PartitionInfoMaximumsOversubscribe and assigns it to the Oversubscribe field.
func (o *V0044PartitionInfoMaximums) SetOversubscribe(v V0044PartitionInfoMaximumsOversubscribe) {
	o.Oversubscribe = &v
}
...
// SetOverTimeLimit gets a reference to the given V0044Uint16NoValStruct and assigns it to the OverTimeLimit field.
func (o *V0044PartitionInfoMaximums) SetOverTimeLimit(v V0044Uint16NoValStruct) {
	o.OverTimeLimit = &v
}

func (o V0044PartitionInfoMaximums) MarshalJSON() ([]byte, error) {
...
func (o V0044PartitionInfoMaximums) ToMap() (map[string]interface{}, error) {
...
type NullableV0044PartitionInfoMaximums struct {
	value *V0044PartitionInfoMaximums
	isSet bool
}

func (v NullableV0044PartitionInfoMaximums) Get() *V0044PartitionInfoMaximums {
	return v.value
}

func (v *NullableV0044PartitionInfoMaximums) Set(val *V0044PartitionInfoMaximums) {
	v.value = val
	v.isSet = true
}

func (v NullableV0044PartitionInfoMaximums) IsSet() bool {
	return v.isSet
}

func (v *NullableV0044PartitionInfoMaximums) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0044PartitionInfoMaximums(val *V0044PartitionInfoMaximums) *NullableV0044PartitionInfoMaximums {
	return &NullableV0044PartitionInfoMaximums{value: val, isSet: true}
}

func (v NullableV0044PartitionInfoMaximums) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0044PartitionInfoMaximums) UnmarshalJSON(src []byte) error {
	v.isSet = true
