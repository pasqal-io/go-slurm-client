...
// checks if the V0044JobDescMsg type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0044JobDescMsg{}

// V0044JobDescMsg struct for V0044JobDescMsg
type V0044JobDescMsg struct {
	...
	Rlimits *V0044JobDescMsgRlimits `json:"rlimits,omitempty"`
...
// SetBeginTime gets a reference to the given V0044Uint64NoValStruct and assigns it to the BeginTime field.
...
// SetCrontab gets a reference to the given V0044CronEntry and assigns it to the Crontab field.
...
func (o *V0044JobDescMsg) GetRlimits() V0044JobDescMsgRlimits {
	if o == nil || IsNil(o.Rlimits) {
		var ret V0044JobDescMsgRlimits
		return ret
	}
	return *o.Rlimits
}
...
// SetRlimits gets a reference to the given V0044JobDescMsgRlimits and assigns it to the Rlimits field.
...
// SetDistributionPlaneSize gets a reference to the given V0044Uint16NoValStruct and assigns it to the DistributionPlaneSize field.
...
// SetKillWarningDelay gets a reference to the given V0044Uint16NoValStruct and assigns it to the KillWarningDelay field.
...
// SetRequiredSwitches gets a reference to the given V0044Uint32NoValStruct and assigns it to the RequiredSwitches field.
...
// SetSegmentSize gets a reference to the given V0044Uint16NoValStruct and assigns it to the SegmentSize field.
...
func (o V0044JobDescMsg) MarshalJSON() ([]byte, error) {
...
func (o V0044JobDescMsg) ToMap() (map[string]interface{}, error) {
...
type NullableV0044JobDescMsg struct {
	value *V0044JobDescMsg
	isSet bool
}

func (v NullableV0044JobDescMsg) Get() *V0044JobDescMsg {
	return v.value
}

func (v *NullableV0044JobDescMsg) Set(val *V0044JobDescMsg) {
	v.value = val
	v.isSet = true
}

func (v NullableV0044JobDescMsg) IsSet() bool {
	return v.isSet
}

func (v *NullableV0044JobDescMsg) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0044JobDescMsg(val *V0044JobDescMsg) *NullableV0044JobDescMsg {
	return &NullableV0044JobDescMsg{value: val, isSet: true}
}

func (v NullableV0044JobDescMsg) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0044JobDescMsg) UnmarshalJSON(src []byte) error {
	v.isSet = true
