...
type V0044PartitionInfo struct {
	...
	Partition *V0044PartitionInfoPartition `json:"partition,omitempty"`
...
func (o *V0044PartitionInfo) GetPartition() V0044PartitionInfoPartition {
	if o == nil || IsNil(o.Partition) {
		var ret V0044PartitionInfoPartition
		return ret
	}
	return *o.Partition
}
...
// SetPartition gets a reference to the given V0044PartitionInfoPartition and assigns it to the Partition field.
