...
// checks if the V0044PartitionInfoNodes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0044PartitionInfoNodes{}

// V0044PartitionInfoNodes struct for V0044PartitionInfoNodes
type V0044PartitionInfoNodes struct {
...
func (o V0044PartitionInfoNodes) MarshalJSON() ([]byte, error) {
...
func (o V0044PartitionInfoNodes) ToMap() (map[string]interface{}, error) {
...
type NullableV0044PartitionInfoNodes struct {
	value *V0044PartitionInfoNodes
	isSet bool
}

func (v NullableV0044PartitionInfoNodes) Get() *V0044PartitionInfoNodes {
	return v.value
}

func (v *NullableV0044PartitionInfoNodes) Set(val *V0044PartitionInfoNodes) {
	v.value = val
	v.isSet = true
}

func (v NullableV0044PartitionInfoNodes) IsSet() bool {
	return v.isSet
}

func (v *NullableV0044PartitionInfoNodes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0044PartitionInfoNodes(val *V0044PartitionInfoNodes) *NullableV0044PartitionInfoNodes {
	return &NullableV0044PartitionInfoNodes{value: val, isSet: true}
}

func (v NullableV0044PartitionInfoNodes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0044PartitionInfoNodes) UnmarshalJSON(src []byte) error {
	v.isSet = true
