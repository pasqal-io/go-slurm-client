...
// checks if the V0044PartitionInfoPriority type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0044PartitionInfoPriority{}

// V0044PartitionInfoPriority struct for V0044PartitionInfoPriority
type V0044PartitionInfoPriority struct {
...
func NewV0044PartitionInfoPriority() *V0044PartitionInfoPriority {
	this := V0044PartitionInfoPriority{}
	return &this
}
...
func (o V0044PartitionInfoPriority) MarshalJSON() ([]byte, error) {
...
func (o V0044PartitionInfoPriority) ToMap() (map[string]interface{}, error) {
...
type NullableV0044PartitionInfoPriority struct {
	value *V0044PartitionInfoPriority
	isSet bool
}

func (v NullableV0044PartitionInfoPriority) Get() *V0044PartitionInfoPriority {
	return v.value
}

func (v *NullableV0044PartitionInfoPriority) Set(val *V0044PartitionInfoPriority) {
	v.value = val
	v.isSet = true
}

func (v NullableV0044PartitionInfoPriority) IsSet() bool {
	return v.isSet
}

func (v *NullableV0044PartitionInfoPriority) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0044PartitionInfoPriority(val *V0044PartitionInfoPriority) *NullableV0044PartitionInfoPriority {
	return &NullableV0044PartitionInfoPriority{value: val, isSet: true}
}

func (v NullableV0044PartitionInfoPriority) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0044PartitionInfoPriority) UnmarshalJSON(src []byte) error {
	v.isSet = true
