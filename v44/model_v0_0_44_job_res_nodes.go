...
// checks if the V0044JobResNodes type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0044JobResNodes{}

// V0044JobResNodes struct for V0044JobResNodes
type V0044JobResNodes struct {
	...
	Allocation []V0044JobResNode `json:"allocation,omitempty"`
}
...
// SetAllocation gets a reference to the given []V0044JobResNode and assigns it to the Allocation field.
func (o *V0044JobResNodes) SetAllocation(v []V0044JobResNode) {
	o.Allocation = v
}

func (o V0044JobResNodes) MarshalJSON() ([]byte, error) {
...
func (o V0044JobResNodes) ToMap() (map[string]interface{}, error) {
...
type NullableV0044JobResNodes struct {
	value *V0044JobResNodes
	isSet bool
}

func (v NullableV0044JobResNodes) Get() *V0044JobResNodes {
	return v.value
}

func (v *NullableV0044JobResNodes) Set(val *V0044JobResNodes) {
	v.value = val
	v.isSet = true
}

func (v NullableV0044JobResNodes) IsSet() bool {
	return v.isSet
}

func (v *NullableV0044JobResNodes) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0044JobResNodes(val *V0044JobResNodes) *NullableV0044JobResNodes {
	return &NullableV0044JobResNodes{value: val, isSet: true}
}

func (v NullableV0044JobResNodes) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0044JobResNodes) UnmarshalJSON(src []byte) error {
	v.isSet = true
