...
// checks if the V0044KillJobsMsg type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0044KillJobsMsg{}

// V0044KillJobsMsg struct for V0044KillJobsMsg
...
func (o V0044KillJobsMsg) MarshalJSON() ([]byte, error) {
...
func (o V0044KillJobsMsg) ToMap() (map[string]interface{}, error) {
...
type NullableV0044KillJobsMsg struct {
	value *V0044KillJobsMsg
	isSet bool
}

func (v NullableV0044KillJobsMsg) Get() *V0044KillJobsMsg {
	return v.value
}

func (v *NullableV0044KillJobsMsg) Set(val *V0044KillJobsMsg) {
	v.value = val
	v.isSet = true
}

func (v NullableV0044KillJobsMsg) IsSet() bool {
	return v.isSet
}

func (v *NullableV0044KillJobsMsg) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0044KillJobsMsg(val *V0044KillJobsMsg) *NullableV0044KillJobsMsg {
	return &NullableV0044KillJobsMsg{value: val, isSet: true}
}

func (v NullableV0044KillJobsMsg) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0044KillJobsMsg) UnmarshalJSON(src []byte) error {
	v.isSet = true
