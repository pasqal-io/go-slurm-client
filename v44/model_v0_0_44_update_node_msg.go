...
// checks if the V0044UpdateNodeMsg type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &V0044UpdateNodeMsg{}

// V0044UpdateNodeMsg struct for V0044UpdateNodeMsg
...
// SetResumeAfter gets a reference to the given V0044Uint32NoValStruct and assigns it to the ResumeAfter field.
...
// SetWeight gets a reference to the given V0044Uint32NoValStruct and assigns it to the Weight field.
func (o *V0044UpdateNodeMsg) SetWeight(v V0044Uint32NoValStruct) {
	o.Weight = &v
}

func (o V0044UpdateNodeMsg) MarshalJSON() ([]byte, error) {
...
func (o V0044UpdateNodeMsg) ToMap() (map[string]interface{}, error) {
...
type NullableV0044UpdateNodeMsg struct {
	value *V0044UpdateNodeMsg
	isSet bool
}

func (v NullableV0044UpdateNodeMsg) Get() *V0044UpdateNodeMsg {
	return v.value
}

func (v *NullableV0044UpdateNodeMsg) Set(val *V0044UpdateNodeMsg) {
	v.value = val
	v.isSet = true
}

func (v NullableV0044UpdateNodeMsg) IsSet() bool {
	return v.isSet
}

func (v *NullableV0044UpdateNodeMsg) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableV0044UpdateNodeMsg(val *V0044UpdateNodeMsg) *NullableV0044UpdateNodeMsg {
	return &NullableV0044UpdateNodeMsg{value: val, isSet: true}
}

func (v NullableV0044UpdateNodeMsg) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableV0044UpdateNodeMsg) UnmarshalJSON(src []byte) error {
	v.isSet = true
