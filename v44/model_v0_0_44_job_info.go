...
type V0044JobInfo struct {
	...
	Power *V0044JobInfoPower `json:"power,omitempty"`
...
func (o *V0044JobInfo) GetPower() V0044JobInfoPower {
	if o == nil || IsNil(o.Power) {
		var ret V0044JobInfoPower
		return ret
	}
	return *o.Power
}
...
// and a boolean to check if the value has been set.
func (o *V0044JobInfo) GetPowerOk() (*V0044JobInfoPower, bool) {
	if o == nil || IsNil(o.Power) {
		return nil, false
	}
	return o.Power, true
...
// SetPower gets a reference to the given V0044JobInfoPower and assigns it to the Power field.
func (o *V0044JobInfo) SetPower(v V0044JobInfoPower) {
	o.Power = &v
}
